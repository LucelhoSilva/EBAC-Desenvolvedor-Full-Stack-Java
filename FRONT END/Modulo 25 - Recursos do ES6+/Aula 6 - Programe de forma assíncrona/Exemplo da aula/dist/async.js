...
// Promisses
var funcaoMuitoPesadaPromisse = new Promise(function (resolve, reject) {
  try {
    var execucoes = 0;
    for (var i = 0; i < 1000000000; i++) {
      execucoes++;
...
funcaoMuitoPesadaPromisse.then(function (result) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          promiseComParametro('bruno@gmail.com', 123456).then(function (result) {
            return console.log(result);
          });
          _context.prev = 2;
          _context.next = 5;
          return funcaoMuitoPesadaPromisse;
        case 5:
